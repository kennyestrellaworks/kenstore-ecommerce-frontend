      ...
      <div className="cards-v1">
        ...
        >
          {categoryFilter === product.category ? (
            ...
            <div className="product__category-label">{categoryName}</div>
          )}
          <img
            className="cards-v1__image product__image"
            src={product.image ? product.image : defaultImage}
            alt=""
          />
          <h2 className="product__heading cards-v1__heading heading__secondary">
            {product.name}
          </h2>
          <div className="product__rating">
            <p className="product__rating-number">{product.rating}</p>
          ...
          <div className="product__stock">
            <p>
              In stock:&nbsp;
              <span className="product__stock-count">{product.stockCount}</span>
            </p>
          </div>
